...
namespace api.Controllers
{
    ...
    public class CommentController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("{symbol:alpha}")]
        public async Task<IActionResult> Create([FromRoute] string symbol, CreateCommandDto createCommandDto)
        {
            if(!ModelState.IsValid)
                return BadRequest(ModelState);
            ...
            if(stock == null)
            {
                ...
                if(stock == null)
                {
                    return BadRequest("This stock is not exist");
                }
                else
                {
            ...
            var commentModel = createCommandDto.ToCommentFromCreate(stock.Id);
